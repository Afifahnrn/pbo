...
class TextToSpeechApp:
    def __init__(self, root):
        ...
        self.label_author = tk.Label(root, text="AFIFAH NURAINI 220511027")
        ...
        languages = ["Indonesia", "Inggris", "Cina Sederhana", "Jepang"]  # Nama bahasa untuk Cina Sederhana, Inggris, Jepang
